...
{
    /// <summary>
    /// Phone application page for Statistics_Detail.
    /// </summary>
    [CompilerGenerated]
    [GeneratedCode("Radarc", "4.0")]
    public partial class Statistics_Detail : PhoneApplicationPage
    {       
        /// <summary>
        /// Initializes the phone application page for Statistics_Detail and all its components.
        /// </summary>
        public Statistics_Detail()
        {
            InitializeComponent();        
			if (Resources.Contains("PanoramaStatistics_Detail0AppBar"))
				PhonePage.SetApplicationBar(this, Resources["PanoramaStatistics_Detail0AppBar"] as BindableApplicationBar);                            
		}
		
        private void panoramaStatistics_Detail_SelectionChanged(object sender, SelectionChangedEventArgs e)
        {		
			InitializeAppBarpanoramaStatistics_Detail(PanoramaStatistics_Detail.SelectedItem as PanoramaItem);
        }
		
		private void InitializeAppBarpanoramaStatistics_Detail(PanoramaItem panoramaItem)        
        {
        ...
        protected override  void OnNavigatedTo(NavigationEventArgs e)
        {
            ...
            {
				var dataSource = new Ioc.Container().Resolve<Repositories.IStatistics_Statistics>();
				AddHomeAppBarButton();
				...
				((IViewModels.IStatistics_DetailViewModel)DataContext).CurrentStatisticsSchema = pinnedItem;				
			}
		}
